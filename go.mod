...
require (
	...
	github.com/scalarorg/bitcoin-vault/ffi/go-vault v0.0.0-20241118105335-8f66b4e0bec4
	github.com/scalarorg/bitcoin-vault/go-utils v0.0.0-20241118180356-dbc77b48425b
