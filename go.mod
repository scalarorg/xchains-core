...
require (
	...
	github.com/scalarorg/bitcoin-vault/ffi/go-vault v0.0.0-20241119065544-05ccae022491
	github.com/scalarorg/bitcoin-vault/go-utils v0.0.0-20241119085429-18c39ec6950a
